# 01 — Add Pythonic proposal admission

**What to build:** Karel and MiniGrid model responses admit a Candidate Program through a
restricted Python program that the system deterministically lowers and validates as canonical DSL.
New executions receive a distinct, reproducible Proposal Protocol and Experiment Manifest identity.
