# 02 — Admit conservative DSL backups

**What to build:** When Python cannot be admitted, a DSL backup can still produce a Candidate
Program only through documented semantics-preserving normalization; otherwise correction receives
bounded, self-contained diagnostics for both representations.
