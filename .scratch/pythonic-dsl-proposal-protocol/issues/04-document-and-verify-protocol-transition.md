...
- [ ] The glossary defines the new proposal and admission vocabulary without implementation detail.
- [ ] A new ADR records the deterministic Python-first lowering, conservative fallback boundary, and historical compatibility rationale.
- [ ] Full automated verification covers proposer, execution, storage, reporting, matrix aggregation, and Karel/MiniGrid compatibility.
- [ ] No live run or new direct-versus-Pythonic ablation is introduced.
